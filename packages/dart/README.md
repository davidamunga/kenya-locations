...
**❗ In order to start using Kenya Locations you must have the [Dart SDK][dart_install_link] installed on your machine.**
...
Kenya Locations comes with a built-in [GitHub Actions workflow][github_actions_link] powered by [Very Good Workflows][very_good_workflows_link] but you can also add your preferred CI/CD solution.
